/* globals icodetutsfrminput jQuery */
...
(function ($) {
  ...
  function _removeFormGroupFocus(element) {
    $(element)
      .parent()
      .parent(".input-group")
      .removeClass("prefix"); /// By arun
    $(element)
      .closest(".form-group")
      .removeClass("is-focused"); // remove class from form-group
  }
  ...
  $.icodetutsfrminput = {
    ...
    checkbox: function (selector) {
      ...
      var $input = $(selector ? selector : this.options.checkboxElements)
        ...
        .data("mdproc", true)
        .after(
          "<span class='checkbox-icodetutsfrminput'><span class='check'></span></span>"
        );
